                    ...
                    <div className="lg:w-1/2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
                            <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                                ...
                                <p className="text-sm text-slate-500 leading-relaxed">ה-GDP של DFW הוא 744.5 מיליארד דולר, מה שהופך אותה לכלכלה ה-20 בגודלה בעולם - שווה ערך למדינה ריבונית.</p>
                            </div>
                            <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
                                <Briefcase className="text-gold mb-4" size={32} />
                                <h4 className="text-xl font-black text-navy mb-2">מרכז Fortune 500</h4>
                                <p className="text-sm text-slate-500 leading-relaxed">נהירה של חברות ענק מכל ארה"ב בזכות מיסוי נמוך, רגולציה נוחה ואיכות חיים.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative group flex justify-center py-10">
                        ...
                        <div className="relative z-10 w-full max-w-3xl px-6 md:px-0">
                            <img
                                ...
                                className="w-full h-auto object-contain transition-all duration-700 group-hover:scale-[1.02] filter drop-shadow-2xl"
                            />

                            {/* Animated Gold Dot for DFW */}
                            <div className="absolute top-[63.5%] left-[49.5%] -translate-x-1/2 -translate-y-1/2 pointer-events-none">
                                <div className="relative flex h-8 w-8 md:h-12 md:w-12">
                                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-gold opacity-75"></span>
                                    <span className="relative inline-flex rounded-full h-8 w-8 md:h-12 md:w-12 bg-gold shadow-[0_0_25px_rgba(245,196,81,0.9)] border-2 border-white/30"></span>
                                </div>
                            </div>
                        </div>
                    </div>
