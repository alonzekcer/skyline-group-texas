                                ...
                                <form className="space-y-8" onSubmit={handleSubmit}>
                                    <div className="space-y-2 text-right">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-8 py-6 rounded-3xl bg-slate-50 border border-slate-200 outline-none focus:ring-4 focus:ring-gold/20 font-black text-navy transition-all text-right"
                                    ...
                                    <div className="space-y-2 text-right">
                                        ...
                                        <select
                                            ...
                                            className="w-full px-8 py-6 rounded-3xl bg-slate-50 border border-slate-200 outline-none focus:ring-4 focus:ring-gold/20 font-black text-navy transition-all appearance-none cursor-pointer text-right"
                                        >
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-navy text-gold font-black py-8 rounded-3xl shadow-2xl hover:bg-slate-800 transition-all text-2xl uppercase tracking-tighter mt-8 flex items-center justify-center gap-4 disabled:opacity-50"
                                    >
