...
export const FULL_SUPPORT: SupportStep[] = [
    ...
    { id: 8, title: 'הכנה ל-Section 8', description: 'התאמת הנכס לדרישות המחמירות של התוכנית הממשלתית.', icon: '⚖️' },
    ...
    { id: 11, title: 'כלים לניהול עצמי', description: 'מערכות מתקדמות לגבייה אוטומטית ומעקב שקוף.', icon: '📱' },
